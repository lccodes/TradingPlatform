...
\mydef{Rational Expectations}, \mydef{Prior Information}, and \mydef{Prior Information Timing} provide three definitions for ground truth against which we can compare the final prediction for our \mydef{market makers}. All three equilibria suggest that the market's final prediction will predict the true outcome. \\
